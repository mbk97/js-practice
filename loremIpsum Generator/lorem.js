...
form.addEventListener("submit", (e) => {
  ...
  const value = parseInt(paragraphInput.value);

  //** check if the paragraph value passes the following test, 1. the value must be a number 2. the value must be greater than 0 3. the value must not be more than 11

  if (isNaN(value) || value < 0 || value > 11) {
    alert("You can only generate between 1 to 11 paragraphs");
  }
